...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%% ZUPT + corrections (testing "The Rotational Symmetry of the Sensors") %
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %

range = 1:6;
[rmse_ZUPT_B,rmse_GPs,rmse_NNs,rmse_static_B] = SymmetryB_main(inertial,ground_truth,inds,range);

% % % % % % % % % % % % % % % %
%% Article plot: rmse vs time %
% % % % % % % % % % % % % % % %

plot_rmse_vs_time2(rmse_ZUPT,rmse_static,rmse_NNs,rmse_GPs,range)
