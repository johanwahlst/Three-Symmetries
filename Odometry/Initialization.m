...
simdata.sigma_acc =1.3*[1 1 1]';

% Process noise for modeling the gyroscope noise (x,y,z platform coordinate
% axis) and other gyroscope errors [rad/s].
% simdata.sigma_gyro =0.01*[1 1 1]'*pi/180; % [rad/s]
simdata.sigma_gyro =0.1*[1 1 1]'*pi/180; % [rad/s]
...
simdata.sigma_initial_att=(pi/180*[100 100 0.1]');      % Attitude (roll,pitch,heading) [rad]
